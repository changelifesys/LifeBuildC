<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fire18SignUp03.aspx.cs" Inherits="LifeBuildC.Fire18SignUp03" %>
        ...
        <div>
            ...
            <div class="el-row" style="margin-left: -10px; margin-right: -10px;">
                ...
                <div class="el-col el-col-12 el-col-offset-6 el-col-xs-18 el-col-xs-offset-3" style="padding-left: 10px; padding-right: 10px;">
                    <div role="alert" class="el-alert el-alert--success is-center">
                    ...
                    <p class="user">小組：<asp:Label ID="lblGroupName" runat="server" Text=""></asp:Label></p>
                    <p class="user">姓名：<asp:Label ID="lblEname" runat="server" Text=""></asp:Label></p>
                    <p class="user">手機：<asp:Label ID="lblPhone" runat="server" Text=""></asp:Label></p>
                    <p class="user">信箱：<asp:Label ID="lblGmail" runat="server" Text=""></asp:Label></p>
