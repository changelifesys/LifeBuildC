...
{
    public partial class SubjectC2MAdd : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = Ado_Info.SubjectInfo_ADO.Get_SubjectInfo_MaxSID_WHERE_CategoryID("C2M");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string SubName = "生命建造程序 C2 榮耀男人課程報名";
            ...
            Ado_Info.SubjectInfo_ADO.InsSubjectInfo(SubCount, "C2M", SubName, SUCondition, SubLocation,
                                                                                            SubStrDate, SubEndDate, Memo, HtmlSubDesc, int.Parse(txtlimit.Text));

            DataTable dtSubjectInfo = Ado_Info.SubjectInfo_ADO.QueryMaxSIDBySubjectInfo("C2M");
            int SID = int.Parse(dtSubjectInfo.Rows[0]["SID"].ToString());

            Ado_Info.SubjectDate_ADO.InsSubjectDate(SID, "C2M", txtSDate.Text.Trim(),
