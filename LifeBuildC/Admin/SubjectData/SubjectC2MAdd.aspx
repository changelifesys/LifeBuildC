<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectC2MAdd.aspx.cs" Inherits="LifeBuildC.Admin.SubjectData.SubjectC2MAdd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>新增C2 榮耀男人課程</title>
    <meta charset="utf-8" />
...
<form role="form" runat="server">
        <asp:HiddenField ID="CategoryID" Value="C2M" runat="server" />
        <div>
            <center>
