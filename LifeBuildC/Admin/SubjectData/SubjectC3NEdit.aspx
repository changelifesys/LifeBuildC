<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectC3NEdit.aspx.cs" Inherits="LifeBuildC.Admin.SubjectData.SubjectC3NEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>編輯C3 九型人格課程</title>
    <meta charset="utf-8" />
...
<form role="form" runat="server">
        <asp:HiddenField ID="CategoryID" Value="C3N" runat="server" />
        <div>
            <center>
