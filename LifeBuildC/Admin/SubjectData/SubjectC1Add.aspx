                ...
                <table id="tableMem" style="width: 500px;" align="center" border="1">
                    ...
                    <tr style="height: 40px;">
                        ...
                        <td style="background-color: rgb(239,239,239); text-align: left;">
                            &nbsp;&nbsp;<asp:TextBox Enabled="false" ID="txtSubCount1" CssClass="inputStyle" ReadOnly="true" runat="server" Width="50px"></asp:TextBox>年&nbsp;/
                            &nbsp;第<asp:TextBox Enabled="false" CssClass="inputStyle" ID="txtSubCount2" ReadOnly="true" runat="server" Width="50px"></asp:TextBox>次開課
                        </td>
                    </tr>
                    <!--報名條件-->
                    <tr style="height: 40px;">
