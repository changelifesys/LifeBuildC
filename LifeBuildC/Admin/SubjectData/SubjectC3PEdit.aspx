<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectC3PEdit.aspx.cs" Inherits="LifeBuildC.Admin.SubjectData.SubjectC3PEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>編輯C3 人際關係課程</title>
    <meta charset="utf-8" />
        ...
        <div>
            ...
            <div>
                <table id="tableMem" style="width: 500px;" align="center" border="1">
                    ...
                    <tr style="height: 40px;">
                        <td style="width: 150px; background-color: rgb(204,204,204)">
                            <asp:Label ID="Label1" ForeColor="Black" Font-Bold="true" runat="server" Text="C3 九型人格"></asp:Label>
                        </td>
                        <td style="background-color: rgb(239,239,239); text-align: center;">【C3 人際關係】上課時間：
