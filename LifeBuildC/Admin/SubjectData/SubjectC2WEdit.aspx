<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectC2WEdit.aspx.cs" Inherits="LifeBuildC.Admin.SubjectData.SubjectC2WEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>編輯C2 幸福女人課程</title>
    <meta charset="utf-8" />
...
<form role="form" runat="server">
        <asp:HiddenField ID="CategoryID" Value="C2W" runat="server" />
        <div>
            <center>
            ...
            <div>
                <table id="tableMem" style="width: 500px;" align="center" border="1">
                    ...
                    <tr style="height: 40px;">
                        <td style="width: 150px; background-color: rgb(204,204,204)">
                            <asp:Label ID="Label1" ForeColor="Black" Font-Bold="true" runat="server" Text="C2 幸福女人"></asp:Label>
                        </td>
                        <td style="background-color: rgb(239,239,239); text-align: center;">【C2 幸福女人】上課時間：
