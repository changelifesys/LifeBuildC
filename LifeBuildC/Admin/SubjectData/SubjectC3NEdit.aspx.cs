...
{
    public partial class SubjectC3NEdit : System.Web.UI.Page
    {
        ...
        private void PageDataLoad()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //上課時間
                txtSDate.Text = DateTime.Parse(dt.Select("CategoryID2='C3N'")[0]["SDate"].ToString()).ToString("yyyy/MM/dd");
                txtSubTime.Text = dt.Select("CategoryID2='C3N'")[0]["SubTime"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //上課時間
            Ado_Info.SubjectDate_ADO.DelSubjectDate(SID, "C3N");
