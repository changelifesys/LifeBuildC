<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fire18SignUp.aspx.cs" Inherits="LifeBuildC.Fire18SignUp" %>
                    ...
                    <form class="el-form">
                        <div role="alert" class="el-alert el-alert--warning is-center">
                            ...
                            <div class="el-alert__content">
                                <p class="el-alert__description">請先到櫃台繳費取得一組密碼後，才能進行烈火特會報名</p>
                                <i class="el-alert__closebtn el-icon-close" style="display: none;"></i>
                            </div>
                        </div>

                        <div class="el-form-item is-required">
                            <label for="password" class="el-form-item__label" style="width: 80px;">繳費密碼</label><div class="el-form-item__content" style="margin-left: 80px;">
                                <div class="el-input">
                                    <input autocomplete="off" id="txtPassKey" placeholder="請輸入繳費密碼" type="password" rows="2" validateevent="true" class="el-input__inner" runat="server" />
                                </div>
                            </div>
                        </div>
...
<%--                                <button type="button" class="el-button el-button--default el-button--small">
                                ...
                                <asp:Button ID="btnSend" CssClass="el-button el-button--default el-button--small" runat="server" Text="送出" OnClick="btnSend_Click" />
                            </div>
                        </div>
                    </form>
                </div>
